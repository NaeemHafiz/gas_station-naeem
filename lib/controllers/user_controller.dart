...
class UserController extends GetxController {
  ...
  Future<void> addUser(UserModel userModel, BuildContext buildContext,String userType) async {
    WidgetProperties.showLoader(buildContext);
    await fireStoreService.addUser(userModel,userType);
    updateUserBuilder();
